...
public class FibonacciNumberPrinter {
    ...
    public void printFirstFibonacciNumbers( final int wantedNumberOfFibonacciNumbers ){
        ...
        int i;                                     // count helper 
        boolean negativeFibu;                       // Remember if Wanted number is positive or negative
        ...
        //Check - wanted Number negative? Initialisation - set negative input to true. 
        if (wantedNumberOfFibonacciNumbers > 0) {
            negativeFibu = false; 
        } else {
            n = wantedNumberOfFibonacciNumbers*(-1); 
            negativeFibu = true; }
        ...
        for (i = 0; i < n; i++) {
            ...
            //Print based on positve or negative Fibonacci

            if (negativeFibu != true) {

                //prints all numbers except the last one
            ...
            //Print "," as long as fibSum is smaller as WantedFibbonacci
            if (fibuSum != wantedNumberOfFibonacciNumbers) {
                System.out.printf(", ");
            }

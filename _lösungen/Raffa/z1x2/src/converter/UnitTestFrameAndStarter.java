...
public class UnitTestFrameAndStarter {
    ...
    public void testXXNP(){
        System.out.println("testXXNP - start");
        doTestRaisingException(16);
        System.out.println("testXXNP - 16");
        doTestRaisingException( 42 );
        System.out.println("testXXNP - 42");
        doTestRaisingException( 1_000 );
        System.out.println("testXXNP - 1_000");
        doTestRaisingException( 1_000_000 );
        System.out.println("testXXNP - 1_000_000");
        doTestRaisingException( -1 );
        System.out.println("testXXNP - -1");
        doTestRaisingException( -13 );
        System.out.println("testXXNP - -13");
        doTestRaisingException( Integer.MAX_VALUE );
        System.out.println("testXXNP - Integer.MAX_VALUE");
        doTestRaisingException( Integer.MIN_VALUE );
        System.out.println("testXXNP - Integer.MIN_VALUE");
    }//method()
    //
